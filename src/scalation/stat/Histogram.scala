      ...
      extends MainFrame
{
    ...
    private val intervalWidth = (maxValue - minValue) / numIntervals.asInstanceOf [Double] // + epsilon
    ...
    {
        val c      = new MatrixN [Double] (numIntervals, 4)
...
/*
    ...
    val normalDist = new VectorN [Double] (samples)
