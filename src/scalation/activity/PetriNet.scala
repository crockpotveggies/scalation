...
class Transition (val x: Double, val y: Double, firingDist: Variate, colors: Array [Color])
      extends Ordered [Transition] with PetriNetRules with PQItem with Identity
{
      ...
      extends PetriNetRules with Error
{
    ...
    /** Number of discrete places (which hold entitys)
     */
...
object PetriNetTest extends App
{
    ...
    val colors = Array [Color] (Colors.green, Colors.blue, Colors.purple)
